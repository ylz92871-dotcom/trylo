// TS declaration for the sidecar's pinned autocad-mcp manifest (see officecli.d.mts).
//
...
export declare const AUTOCAD_MCP_MANIFEST: Readonly<CadToolManifestShape>;
