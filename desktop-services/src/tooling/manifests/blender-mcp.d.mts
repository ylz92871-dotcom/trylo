// TS declaration for the sidecar's pinned blender-mcp manifest (see officecli.d.mts).
//
...
export declare const BLENDER_MCP_MANIFEST: Readonly<CadToolManifestShape>;
