// TS declaration for the sidecar's pinned freecad-mcp manifest (see officecli.d.mts).
//
...
export declare const FREECAD_MCP_MANIFEST: Readonly<CadToolManifestShape>;
