// TS declaration for the sidecar's pinned solidworks-mcp manifest (see officecli.d.mts).
//
...
export declare const SOLIDWORKS_MCP_MANIFEST: Readonly<CadToolManifestShape>;
